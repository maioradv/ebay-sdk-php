...
use maiorADV\eBaySDK\Test\Mocks\SimpleClass;
use maiorADV\eBaySDK\Test\Mocks\Base64BinaryType;
use maiorADV\eBaySDK\Test\Mocks\BooleanType;
use maiorADV\eBaySDK\Test\Mocks\DecimalType;
use maiorADV\eBaySDK\Test\Mocks\DoubleType;
use maiorADV\eBaySDK\Test\Mocks\IntegerType;
use maiorADV\eBaySDK\Test\Mocks\StringType;
use maiorADV\eBaySDK\Test\Mocks\TokenType;
use maiorADV\eBaySDK\Test\Mocks\URIType;
...
class SimpleClassTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Test\Mocks\SimpleClass', $this->obj);
    }
    ...
    public function testGettingSettingProperties()
    {
        ...
        $this->assertInstanceOf('\maiorADV\eBaySDK\Test\Mocks\SimpleClass', $this->obj->SimpleClass);

        $this->assertEquals(0, count($this->obj->strings));
        $this->assertInstanceOf('\maiorADV\eBaySDK\Types\RepeatableType', $this->obj->strings);
        ...
        $this->assertInstanceOf('\maiorADV\eBaySDK\Types\RepeatableType', $this->obj->integers);
        ...
        $this->assertInstanceOf('\maiorADV\eBaySDK\Types\RepeatableType', $this->obj->anyTypes);
        $this->obj->anyTypes[] = 1;
    ...
    {
        $this->setExpectedException('\maiorADV\eBaySDK\Exceptions\UnknownPropertyException', 'Unknown property foo');
    ...
    {
        $this->setExpectedException('\maiorADV\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integer. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\maiorADV\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected integer but got string');
    ...
    {
        $this->setExpectedException('\maiorADV\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for integers. Expected maiorADV\eBaySDK\Types\RepeatableType but got integer');
    ...
    public function testCanGetElementMeta()
    {
        ...
        $meta->phpType = 'maiorADV\eBaySDK\Test\Mocks\SimpleClass';
