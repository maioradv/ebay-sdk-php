...
use maiorADV\eBaySDK\Types\RepeatableType;
...
class RepeatableTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Types\RepeatableType', $this->obj);
    }
    ...
    {
        $this->setExpectedException('\maiorADV\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for . Expected string but got integer');
