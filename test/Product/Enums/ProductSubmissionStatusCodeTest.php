...
use maiorADV\eBaySDK\Product\Enums\ProductSubmissionStatusCode;
...
class ProductSubmissionStatusCodeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Product\Enums\ProductSubmissionStatusCode', $this->obj);
    }
}
