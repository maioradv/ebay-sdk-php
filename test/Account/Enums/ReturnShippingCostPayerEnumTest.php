...
use maiorADV\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum;
...
class ReturnShippingCostPayerEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Account\Enums\ReturnShippingCostPayerEnum', $this->obj);
    }
}
