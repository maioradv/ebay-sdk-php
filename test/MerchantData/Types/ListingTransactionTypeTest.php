...
use maiorADV\eBaySDK\MerchantData\Types\ListingTransactionType;
...
class ListingTransactionTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Types\ListingTransactionType', $this->obj);
    }
