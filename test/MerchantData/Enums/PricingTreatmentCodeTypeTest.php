...
use maiorADV\eBaySDK\MerchantData\Enums\PricingTreatmentCodeType;
...
class PricingTreatmentCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\PricingTreatmentCodeType', $this->obj);
    }
}
