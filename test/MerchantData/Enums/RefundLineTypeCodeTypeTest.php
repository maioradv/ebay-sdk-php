...
use maiorADV\eBaySDK\MerchantData\Enums\RefundLineTypeCodeType;
...
class RefundLineTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\RefundLineTypeCodeType', $this->obj);
    }
}
