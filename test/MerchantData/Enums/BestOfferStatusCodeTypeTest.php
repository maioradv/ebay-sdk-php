...
use maiorADV\eBaySDK\MerchantData\Enums\BestOfferStatusCodeType;
...
class BestOfferStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\BestOfferStatusCodeType', $this->obj);
    }
}
