...
use maiorADV\eBaySDK\MerchantData\Enums\MeasurementSystemCodeType;
...
class MeasurementSystemCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\MeasurementSystemCodeType', $this->obj);
    }
}
