...
use maiorADV\eBaySDK\MerchantData\Enums\ShippingRateTypeCodeType;
...
class ShippingRateTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\ShippingRateTypeCodeType', $this->obj);
    }
}
