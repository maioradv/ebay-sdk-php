...
use maiorADV\eBaySDK\MerchantData\Enums\PayPalAccountTypeCodeType;
...
class PayPalAccountTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\PayPalAccountTypeCodeType', $this->obj);
    }
}
