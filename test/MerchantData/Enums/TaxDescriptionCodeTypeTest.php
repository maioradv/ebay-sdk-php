...
use maiorADV\eBaySDK\MerchantData\Enums\TaxDescriptionCodeType;
...
class TaxDescriptionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\TaxDescriptionCodeType', $this->obj);
    }
}
