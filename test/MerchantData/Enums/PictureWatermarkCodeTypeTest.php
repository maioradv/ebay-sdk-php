...
use maiorADV\eBaySDK\MerchantData\Enums\PictureWatermarkCodeType;
...
class PictureWatermarkCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\PictureWatermarkCodeType', $this->obj);
    }
}
