...
use maiorADV\eBaySDK\MerchantData\Enums\PaymentHoldStatusCodeType;
...
class PaymentHoldStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\PaymentHoldStatusCodeType', $this->obj);
    }
}
