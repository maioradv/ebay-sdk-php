...
use maiorADV\eBaySDK\MerchantData\Enums\BuyerProtectionCodeType;
...
class BuyerProtectionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\BuyerProtectionCodeType', $this->obj);
    }
}
