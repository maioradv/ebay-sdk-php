...
use maiorADV\eBaySDK\MerchantData\Enums\TopRatedProgramCodeType;
...
class TopRatedProgramCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\TopRatedProgramCodeType', $this->obj);
    }
}
