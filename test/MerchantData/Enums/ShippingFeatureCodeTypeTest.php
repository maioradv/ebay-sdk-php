...
use maiorADV\eBaySDK\MerchantData\Enums\ShippingFeatureCodeType;
...
class ShippingFeatureCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\ShippingFeatureCodeType', $this->obj);
    }
}
