...
use maiorADV\eBaySDK\MerchantData\Enums\PaymentHoldReasonCodeType;
...
class PaymentHoldReasonCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\PaymentHoldReasonCodeType', $this->obj);
    }
}
