...
use maiorADV\eBaySDK\MerchantData\Enums\ListingSubtypeCodeType;
...
class ListingSubtypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\ListingSubtypeCodeType', $this->obj);
    }
}
