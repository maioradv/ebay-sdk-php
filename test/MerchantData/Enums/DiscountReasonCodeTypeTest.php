...
use maiorADV\eBaySDK\MerchantData\Enums\DiscountReasonCodeType;
...
class DiscountReasonCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\DiscountReasonCodeType', $this->obj);
    }
}
