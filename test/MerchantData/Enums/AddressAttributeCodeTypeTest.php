...
use maiorADV\eBaySDK\MerchantData\Enums\AddressAttributeCodeType;
...
class AddressAttributeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\AddressAttributeCodeType', $this->obj);
    }
}
