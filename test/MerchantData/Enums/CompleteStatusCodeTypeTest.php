...
use maiorADV\eBaySDK\MerchantData\Enums\CompleteStatusCodeType;
...
class CompleteStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\CompleteStatusCodeType', $this->obj);
    }
}
