...
use maiorADV\eBaySDK\MerchantData\Enums\ShippingPackageCodeType;
...
class ShippingPackageCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\ShippingPackageCodeType', $this->obj);
    }
}
