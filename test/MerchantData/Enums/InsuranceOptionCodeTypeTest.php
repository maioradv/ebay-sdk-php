...
use maiorADV\eBaySDK\MerchantData\Enums\InsuranceOptionCodeType;
...
class InsuranceOptionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\InsuranceOptionCodeType', $this->obj);
    }
}
