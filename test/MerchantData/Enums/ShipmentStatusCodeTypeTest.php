...
use maiorADV\eBaySDK\MerchantData\Enums\ShipmentStatusCodeType;
...
class ShipmentStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\MerchantData\Enums\ShipmentStatusCodeType', $this->obj);
    }
}
