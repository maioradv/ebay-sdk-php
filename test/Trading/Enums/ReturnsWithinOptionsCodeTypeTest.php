...
use maiorADV\eBaySDK\Trading\Enums\ReturnsWithinOptionsCodeType;
...
class ReturnsWithinOptionsCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\ReturnsWithinOptionsCodeType', $this->obj);
    }
}
