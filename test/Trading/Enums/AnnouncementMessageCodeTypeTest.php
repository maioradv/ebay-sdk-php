...
use maiorADV\eBaySDK\Trading\Enums\AnnouncementMessageCodeType;
...
class AnnouncementMessageCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\AnnouncementMessageCodeType', $this->obj);
    }
}
