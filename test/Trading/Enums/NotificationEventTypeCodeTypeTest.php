...
use maiorADV\eBaySDK\Trading\Enums\NotificationEventTypeCodeType;
...
class NotificationEventTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\NotificationEventTypeCodeType', $this->obj);
    }
}
