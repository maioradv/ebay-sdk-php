...
use maiorADV\eBaySDK\Trading\Enums\AccountEntrySortTypeCodeType;
...
class AccountEntrySortTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\AccountEntrySortTypeCodeType', $this->obj);
    }
}
