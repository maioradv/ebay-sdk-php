...
use maiorADV\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType;
...
class PayPalAccountStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\PayPalAccountStatusCodeType', $this->obj);
    }
}
