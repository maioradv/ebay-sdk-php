...
use maiorADV\eBaySDK\Trading\Enums\PaymentMethodSearchCodeType;
...
class PaymentMethodSearchCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\PaymentMethodSearchCodeType', $this->obj);
    }
}
