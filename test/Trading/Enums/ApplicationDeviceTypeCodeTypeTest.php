...
use maiorADV\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType;
...
class ApplicationDeviceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\ApplicationDeviceTypeCodeType', $this->obj);
    }
}
