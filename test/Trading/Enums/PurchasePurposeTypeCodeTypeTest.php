...
use maiorADV\eBaySDK\Trading\Enums\PurchasePurposeTypeCodeType;
...
class PurchasePurposeTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\PurchasePurposeTypeCodeType', $this->obj);
    }
}
