...
use maiorADV\eBaySDK\Trading\Enums\TransactionPlatformCodeType;
...
class TransactionPlatformCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\TransactionPlatformCodeType', $this->obj);
    }
}
