...
use maiorADV\eBaySDK\Trading\Enums\ShippingTrackingEventCodeType;
...
class ShippingTrackingEventCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\ShippingTrackingEventCodeType', $this->obj);
    }
}
