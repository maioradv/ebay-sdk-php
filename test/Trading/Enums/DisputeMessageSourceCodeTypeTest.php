...
use maiorADV\eBaySDK\Trading\Enums\DisputeMessageSourceCodeType;
...
class DisputeMessageSourceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\DisputeMessageSourceCodeType', $this->obj);
    }
}
