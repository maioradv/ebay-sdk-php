...
use maiorADV\eBaySDK\Trading\Enums\PromotionalSaleStatusCodeType;
...
class PromotionalSaleStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\maiorADV\eBaySDK\Trading\Enums\PromotionalSaleStatusCodeType', $this->obj);
    }
}
