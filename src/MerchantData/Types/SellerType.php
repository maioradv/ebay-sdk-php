 ...
 * @property \maiorADV\eBaySDK\MerchantData\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \maiorADV\eBaySDK\MerchantData\Enums\SellerLevelCodeType $SellerLevel
 * @property \maiorADV\eBaySDK\MerchantData\Types\AddressType $SellerPaymentAddress
 * @property \maiorADV\eBaySDK\MerchantData\Types\SchedulingInfoType $SchedulingInfo
 * @property boolean $StoreOwner
 * @property string $StoreURL
 * @property \maiorADV\eBaySDK\MerchantData\Enums\SellerBusinessCodeType $SellerBusinessType
 * @property boolean $RegisteredBusinessSeller
 * @property \maiorADV\eBaySDK\MerchantData\Enums\SiteCodeType $StoreSite
 * @property \maiorADV\eBaySDK\MerchantData\Enums\SellerPaymentMethodCodeType $PaymentMethod
 * @property boolean $CharityRegistered
 * @property boolean $SafePaymentExempt
 * @property integer $PaisaPayEscrowEMIStatus
 * @property \maiorADV\eBaySDK\MerchantData\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \maiorADV\eBaySDK\MerchantData\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \maiorADV\eBaySDK\MerchantData\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \maiorADV\eBaySDK\MerchantData\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \maiorADV\eBaySDK\MerchantData\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
...
class SellerType extends \maiorADV\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'maiorADV\eBaySDK\MerchantData\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'maiorADV\eBaySDK\MerchantData\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'maiorADV\eBaySDK\MerchantData\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'maiorADV\eBaySDK\MerchantData\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'maiorADV\eBaySDK\MerchantData\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'maiorADV\eBaySDK\MerchantData\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
