 ...
 * @property \maiorADV\eBaySDK\Trading\Enums\FeatureIDCodeType[] $FeatureID
 * @property boolean $AllFeaturesForCategory
 */
class GetCategoryFeaturesRequestType extends \maiorADV\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
