 ...
 * @property \maiorADV\eBaySDK\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \maiorADV\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
