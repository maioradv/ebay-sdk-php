 ...
 * @property \maiorADV\eBaySDK\Browse\Enums\RefundMethodEnum $refundMethod
 * @property string $restockingFeePercentage
 * @property string $returnInstructions
 * @property \maiorADV\eBaySDK\Browse\Enums\ReturnMethodEnum $returnMethod
 * @property \maiorADV\eBaySDK\Browse\Types\TimeDuration $returnPeriod
 * @property boolean $returnsAccepted
 * @property \maiorADV\eBaySDK\Browse\Enums\ReturnShippingCostPayerEnum $returnShippingCostPayer
 */
class ItemReturnTerms extends \maiorADV\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'returnPeriod' => [
            'type' => 'maiorADV\eBaySDK\Browse\Types\TimeDuration',
            'repeatable' => false,
            'attribute' => false,
