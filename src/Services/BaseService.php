<?php
namespace maiorADV\eBaySDK\Services;

use maiorADV\eBaySDK\Parser\XmlParser;
...
abstract class BaseService
{
     ...
     */
    private function buildXopDocument(\maiorADV\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s%s%s',
     ...
     */
    protected function buildMultipartFormDataXMLPayload(\maiorADV\eBaySDK\Types\BaseType $request)
    {
        return sprintf(
            '%s%s%s',
            '--boundary'.self::CRLF,
