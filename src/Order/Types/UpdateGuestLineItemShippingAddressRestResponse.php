...
/**
 *
 * @property \maiorADV\eBaySDK\Order\Types\ErrorDetailV3[] $errors
 * @property \maiorADV\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class UpdateGuestLineItemShippingAddressRestResponse extends \maiorADV\eBaySDK\Order\Types\CheckoutSessionResponse
{
    use StatusCodeTrait;
