 ...
 * @property \maiorADV\eBaySDK\ProductMetadata\Types\TypeSpecificInformation $typeSpecificInformation
 * @property boolean $multiValued
 * @property string $canonicalName
 * @property \maiorADV\eBaySDK\ProductMetadata\Types\Tag[] $propertyTags
 * @property string $description
 */
class PropertyMetadata extends \maiorADV\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'typeSpecificInformation' => [
            'type' => 'maiorADV\eBaySDK\ProductMetadata\Types\TypeSpecificInformation',
            'repeatable' => false,
            'attribute' => false,
