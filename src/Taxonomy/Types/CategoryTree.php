...
/**
 *
 * @property \maiorADV\eBaySDK\Taxonomy\Enums\MarketplaceIdEnum[] $applicableMarketplaceIds
 * @property string $categoryTreeId
 * @property string $categoryTreeVersion
 * @property \maiorADV\eBaySDK\Taxonomy\Types\CategoryTreeNode $rootCategoryNode
 */
class CategoryTree extends \maiorADV\eBaySDK\Types\BaseType
{
    /**
