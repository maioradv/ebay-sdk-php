...
use maiorADV\eBaySDK\Credentials\CredentialsInterface;
...
function applyCredentials($value, array &$configuration)
{
    if (is_callable($value)) {
        ...
        throw new \InvalidArgumentException(
            ...
            . 'maiorADV\eBaySDK\Credentials\CredentialsInterface, an associative '
 ...
 *
 * @return \maiorADV\eBaySDK\HttpHandler
 */
...
{
    if (\maiorADV\eBaySDK\Sdk::$STRICT_PROPERTY_TYPES) {
        return true;
    }
