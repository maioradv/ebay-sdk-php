...
/**
 *
 * @property \maiorADV\eBaySDK\Marketing\Types\Amount $amountOffItem
 * @property \maiorADV\eBaySDK\Marketing\Types\Amount $amountOffOrder
 * @property string $percentageOffItem
 * @property string $percentageOffOrder
 */
class DiscountBenefit extends \maiorADV\eBaySDK\Types\BaseType
{
    /**
