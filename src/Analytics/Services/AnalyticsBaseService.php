<?php
namespace maiorADV\eBaySDK\Analytics\Services;

/**
 * Base class for the Analytics service.
 */
class AnalyticsBaseService extends \maiorADV\eBaySDK\Services\BaseRestService
{
    /**
    ...
    public static function getConfigDefinitions()
    {
        ...
        return $definitions + [
            'apiVersion' => [
                'valid' => ['string'],
                'default' => \maiorADV\eBaySDK\Analytics\Services\AnalyticsService::API_VERSION,
                'required' => true
            ],
            'authorization' => [
                'valid' => ['string'],
