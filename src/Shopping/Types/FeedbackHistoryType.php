...
/**
 *
 * @property \maiorADV\eBaySDK\Shopping\Types\FeedbackPeriodType[] $BidRetractionFeedbackPeriods
 * @property \maiorADV\eBaySDK\Shopping\Types\FeedbackPeriodType[] $NegativeFeedbackPeriods
 * @property \maiorADV\eBaySDK\Shopping\Types\FeedbackPeriodType[] $NeutralFeedbackPeriods
 * @property \maiorADV\eBaySDK\Shopping\Types\FeedbackPeriodType[] $PositiveFeedbackPeriods
 * @property \maiorADV\eBaySDK\Shopping\Types\FeedbackPeriodType[] $TotalFeedbackPeriods
 * @property integer $UniqueNegativeFeedbackCount
 * @property integer $UniquePositiveFeedbackCount
 * @property \maiorADV\eBaySDK\Shopping\Types\AverageRatingDetailsType[] $AverageRatingDetails
 * @property integer $NeutralCommentCountFromSuspendedUsers
 * @property integer $UniqueNeutralFeedbackCount
 */
class FeedbackHistoryType extends \maiorADV\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        'BidRetractionFeedbackPeriods' => [
            'type' => 'maiorADV\eBaySDK\Shopping\Types\FeedbackPeriodType',
            'repeatable' => true,
            'attribute' => false,
        ...
        'AverageRatingDetails' => [
            'type' => 'maiorADV\eBaySDK\Shopping\Types\AverageRatingDetailsType',
            'repeatable' => true,
            'attribute' => false,
