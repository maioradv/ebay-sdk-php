 ...
 * @property \maiorADV\eBaySDK\Shopping\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property integer $FeedbackScore
 * @property boolean $UserAnonymized
 * @property boolean $NewUser
 * @property \DateTime $RegistrationDate
 * @property \maiorADV\eBaySDK\Shopping\Enums\SiteCodeType $RegistrationSite
 * @property \maiorADV\eBaySDK\Shopping\Enums\UserStatusCodeType $Status
 * @property \maiorADV\eBaySDK\Shopping\Enums\SellerBusinessCodeType $SellerBusinessType
 ...
 * @property \maiorADV\eBaySDK\Shopping\Enums\SellerLevelCodeType $SellerLevel
 * @property boolean $TopRatedSeller
 */
class SimpleUserType extends \maiorADV\eBaySDK\Types\BaseType
{
    /**
